...
window.shoppingList = document.getElementById("purchasses"); // ul 요소 선택

// getElementsByTagName 사용: 모든 li 태그를 배열로 가져온 후 첫 번째 요소 선택
window.liList = shoppingList.getElementsByTagName("li"); // 모든 li 요소를 배열로 가져옴
window.firstLi = liList[0]; // 첫 번째 li 요소 선택

// firstChild를 사용하여 텍스트 노드 선택 (요소 노드의 실제 텍스트 내용)
window.firstTextNode = firstLi.firstChild; // 텍스트 노드 객체 선택
