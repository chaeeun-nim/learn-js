        ...
        f1((result) => {
            ...
            f1((result) => {
                ...
                f1((result) => {
                    ...
                    f1((result) => {
                        //콜백함수 전달
                        console.log("\t11.f1이후에 호출함!!! " + result + "ms나 걸렸음!!!!");
                        f1((result) => {
                            //콜백함수 전달
                            console.log("\t12.f1이후에 호출함!!! " + result + "ms나 걸렸음!!!!");
                            f1((result) => {
                                //콜백함수 전달
                                console.log("\t13.f1이후에 호출함!!! " + result + "ms나 걸렸음!!!!");
                                f1((result) => {
                                    //콜백함수 전달
                                    console.log("\t14.f1이후에 호출함!!! " + result + "ms나 걸렸음!!!!");
                                    f1((result) => {
                                        //콜백함수 전달
                                        console.log("\t15.f1이후에 호출함!!! " + result + "ms나 걸렸음!!!!");
                                    });
                                });
                            });
                        });
