...
*/
  ...
  // console.log("1-5:", "" == false); // 엄격모드에서 에러
...
*/
  ...
  // console.log("문제2:", age1 > age2); 엄격모드에서 비교불가
...
*/
  ...
  console.log("문제3:", str1 < str2); // true 사전순비교, 엄격모드에서 같은타입끼리 비교연산자 가능
...
*/
  ...
  console.log(typeof emptyVal); // 언디파인드
  ...
  console.log("4-2:", emptyVal == null); // true (느슨한 비교에서는 true) 엄격모드에서 느슨한 비교자체가 안되는건아님. 이정도는됨.
